...
var weapons = []Item{
	{"Glock-18", "оружие", 12, 0, 0},
	{"AK-47", "оружие", 34, 0, 0},
	{"MAC-10", "оружие", 17, 0, 0},
	{"AWP", "оружие", 100, 0, 0},
	{"Scout", "оружие", 72, 0, 0},
}

var armors = []Item{
	{"Броник с незеритовым шлемом", "броня", 0, 84, 0},
	{"Щит", "броня", 0, 15, 0},
	{"Броник", "броня", 0, 36, 0},
	{"Броник с обычным шлемом", "броня", 0, 64, 0},
	{"Броник с золотым шлемом", "броня", 0, 56, 0},
}
...
var consumables = []Item{
	...
	{"Шприц исцеления", "расходник", 0, 0, 34},
}
